...
import { getExerciseDifficultyColor, getExerciseTypeColor } from "@/utils/colors";
      ...
      return (
        ...
        >
          ...
          <View style={styles.exerciseDetails}>
            ...
            {exercise.valores_ejemplo?.repeticiones && (
              <View style={styles.exerciseDetail}>
                <Ionicons
                  name="repeat-outline"
                  size={16}
                ...
                />
                <ThemedText type="small" style={styles.exerciseDetailText}>
                  {exercise.valores_ejemplo?.repeticiones} reps
                </ThemedText>
              </View>
            )}
            {exercise.valores_ejemplo?.duracion_minutos && (
              <View style={styles.exerciseDetail}>
                <Ionicons
                  name="time-outline"
                  size={16}
