            ...
            {selectedMood && (
              <View style={styles.moodFeedback}>
                <ThemedText style={styles.moodFeedbackText}>
                  Gracias por compartir conmigo. Es válido sentirse así, y estoy
                  aquí para apoyarte
                </ThemedText>
              </View>
            )}
          ...
          <View style={styles.card}>
            ...
            <View style={styles.achievementsContainer}>
              <View style={[styles.achievementItem, styles.achievementGreen]}>
                ...
                <ThemedText style={styles.achievementValue}>15 min </ThemedText>
              </View>
              <View style={[styles.achievementItem, styles.achievementPink]}>
                <ThemedText style={styles.achievementText}>
                  Momentos de gratitud
                </ThemedText>
                <ThemedText style={styles.achievementValue}>3 hoy </ThemedText>
              </View>
              <View style={[styles.achievementItem, styles.achievementPurple]}>
                <ThemedText style={styles.achievementText}>
